...
class HearingTest:
    ...
    def analyse_results(self, data, ear):
        ...
        ax.set(title=f"Hearing capacity for {ear} ear", xlim=[100, 2100], ylim=[0, 90], xticks=[125, 250, 500, 1000, 2000], yticks=[0, 20, 40, 60, 80], xlabel='Frequency (Hz)', ylabel='Volume (dB)')
        ax.grid()
        ax.legend()
